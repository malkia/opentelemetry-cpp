 ...
 */
class OPENTELEMETRY_EXPORT_TYPE SpanDataEvent
{
public:
 ...
 */
class OPENTELEMETRY_EXPORT_TYPE SpanDataLink
{
public:
 ...
 */
class OPENTELEMETRY_EXPORT_TYPE SpanData final : public Recordable
{
public:
  SpanData() = default;
  /**
